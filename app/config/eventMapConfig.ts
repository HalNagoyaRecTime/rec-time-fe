 ...
 */
export const eventMapConfigs: Record<string, EventMapConfig> = {
    // event_id: 4 - 走れ〇人〇脚
    "4": {
 ...
 */
export const DEFAULT_MAP_IMAGE_URL = "/images/map-class-area.jpg";

/**
 * イベントIDから地図設定を取得
 */
export function getEventMapConfig(eventId: string): EventMapConfig {
    return (
