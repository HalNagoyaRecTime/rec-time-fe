...
export const apiGet = async (url: string) => {
    try {
        const response = await apiClient.get(baseUrl + url);
...
export const apiPost = async (url: string, data?: unknown) => {
    try {
        const response = await apiClient.post(baseUrl + url, data);
        return response.data;
    } catch (error) {
        return Promise.reject(error);
    }
...
export const apiPut = async (url: string, data?: unknown) => {
    try {
        const response = await apiClient.put(baseUrl + url, data);
        return response.data;
    } catch (error) {
        return Promise.reject(error);
    }
...
export const apiDelete = async (url: string) => {
    try {
        const response = await apiClient.delete(baseUrl + url);
        return response.data;
    } catch (error) {
        return Promise.reject(error);
    }
